...
$showdept = mysql_query($query_showdept, $dbcon) or die(mysql_error());
$row_showdept = mysql_fetch_assoc($showdept);
$totalRows_showdept = mysql_num_rows($showdept);
            ...
            <table align="center" class="table" border="0">
                <tr>
                    <td><?php if ($pageNum_showDepartment > 0) { // Show if not first page  ?>
                            <a class="btn btn-info " id="btnwidth" href="<?php printf("%s?pageNum_showDepartment=%d%s", $currentPage, 0, $queryString_showDepartment); ?>">First</a>
<?php } // Show if not first page  ?></td>
                    <td><?php if ($pageNum_showDepartment > 0) { // Show if not first page  ?>
                            <a class="btn btn-info glyphicon glyphicon-arrow-left" id="btnwidth"  href="<?php printf("%s?pageNum_showDepartment=%d%s", $currentPage, max(0, $pageNum_showDepartment - 1), $queryString_showDepartment); ?>">Previous</a>
<?php } // Show if not first page  ?></td>
                    <td><?php if ($pageNum_showDepartment < $totalPages_showDepartment) { // Show if not last page  ?>
                            <a class="btn btn-info glyphicon glyphicon-arrow-right" id="btnwidth" width="100"  href="<?php printf("%s?pageNum_showDepartment=%d%s", $currentPage, min($totalPages_showDepartment, $pageNum_showDepartment + 1), $queryString_showDepartment); ?>">Next</a>
<?php } // Show if not last page  ?></td>
                    <td><?php if ($pageNum_showDepartment < $totalPages_showDepartment) { // Show if not last page  ?>
                            <a class="btn btn-info" id="btnwidth"  href="<?php printf("%s?pageNum_showDepartment=%d%s", $currentPage, $totalPages_showDepartment, $queryString_showDepartment); ?>">Last</a>
<?php } // Show if not last page  ?></td>
                </tr>
            </table>
                    </div>
