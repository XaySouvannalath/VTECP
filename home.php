...
<div class="w3-card-4"><br>
    ...
    <div class="panel panel-default">
        <!--    <div class="panel-heading cpanelhead panel-success"><h1 align="center"><label>Welcome to iDirection</label></h1></div>-->
        ...
        <div class="slideshow-container">
            ...
            <div class="mySlides fade">
                ...
                <img src="pic/welcome-to-crowne-plaza.jpg" style="width:100%">
                <div class="text">Caption Text</div>
            </div>

            <div class="mySlides fade">
                <div class="numbertext">2 / 3</div>
                <img src="pic/wearenew.jpg" style="width:100%">
                <div class="text">Caption Two</div>
            </div>

            <div class="mySlides fade">
                <div class="numbertext">3 / 3</div>
                <img src="pic/oldstaff.jpg" style="width:100%">
